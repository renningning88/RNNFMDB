...
#import "RNNTable.h"
#define RNNTablePrefixUserDefaultKey @"RNNFMDBKEY"
#define RNNTablePrefixBeforeKey @""
#define RNNTablePrefixAfterKey @""
#define RNNDataBaseName @"rnnfmdb.sqlite"
@class RNNFMDB;
@implementation RNNTable
-(instancetype)init{
    if (self = [super init]) {
        //create the table
...
-(RNNFMDB *)db{
    ...
    _db = [RNNFMDB dbWithDbName:self.databaseName];
...
-(NSString *)prefixAfterKey{
    ...
    _prefixAfterKey = RNNTablePrefixAfterKey;
    return _prefixAfterKey;
}
...
-(NSString *)prefixBeforeKey{
    ...
    _prefixBeforeKey = RNNTablePrefixBeforeKey;
    return _prefixBeforeKey;
}
...
-(NSString *)prefixUserDefaultKey{
    ...
    _prefixUserDefaultKey = RNNTablePrefixUserDefaultKey;
    return _prefixUserDefaultKey;
}
...
-(RNNStructure *)structure{
    ...
    _structure = [[RNNStructure alloc] init];
    return _structure;
}
